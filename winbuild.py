...
Usage examples:
    ...
    python winbuild.py build --board wroom-sh         # ESP32-WROOM + SH1106
    python winbuild.py build --board wroom-ssd        # ESP32-WROOM + SSD1306
...
BOARDS = {
    # Keep the short legacy name, and expose explicit controller variants.
    "wroom":       ("esp32_wroom_sh1106",      "esp32",   "build_wroom"),
    "wroom-sh":    ("esp32_wroom_sh1106",      "esp32",   "build_wroom_sh"),
    "wroom-ssd":   ("esp32_wroom_ssd1306",     "esp32",   "build_wroom_ssd"),
