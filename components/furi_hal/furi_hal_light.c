...
#ifndef BOARD_HAS_DISPLAY_BACKLIGHT
#define BOARD_HAS_DISPLAY_BACKLIGHT 1
#endif
...
#if BOARD_HAS_DISPLAY_BACKLIGHT
...
#else
    ESP_LOGI(TAG, "Display has no controllable backlight");
#endif
