...
void furi_thread_set_stack_size(FuriThread* thread, size_t stack_size) {
    ...
    /* Keep service stacks explicit, but don't inflate every short-lived app
     * (many manifests request 1-2 KB).  On the WROOM this otherwise consumes
     * tens of KB of internal DRAM before the selected app starts. */
