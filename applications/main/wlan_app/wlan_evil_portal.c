...
// fresh-enough answers. ESP32-WROOM has no PSRAM, so keep this cache small
// enough to leave DRAM for the Wi-Fi and Bluetooth stacks.
...
// EXT_RAM_BSS_ATTR places this in PSRAM when available and falls back to
// internal DRAM on ESP32-WROOM.
