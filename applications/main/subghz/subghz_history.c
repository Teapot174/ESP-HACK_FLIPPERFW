...
#define SUBGHZ_HISTORY_MAX       24
/* The original STM32 guard (20 KB) prevents every decode on the 4 MB WROOM.
 * Keep a small emergency margin instead; individual allocations still fail
 * normally if the heap is genuinely exhausted. */
