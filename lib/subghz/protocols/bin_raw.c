...
/* Two buffers are allocated from this value (int32_t + uint8_t).  The stock
 * 2048-sample window costs 10 KB permanently as soon as SubGHz opens. */
#define BIN_RAW_BUF_RAW_SIZE 512
#else
